...
public class CheckCorrs
{
	...
	//	File outFile = new File("C:\\claudeSummary\\simonCrossRho\\kraken_max1\\krakenMax1Corrs_hardRemove.txt");
		...
		File inFile = new File("C:\\claudeSummary\\simonCrossRho\\kraken_2871\\simonData\\paired_counts_table.tsv");
		File outFile = new File("C:\\claudeSummary\\simonCrossRho\\kraken_2871\\simonData\\simonCorr.txt");
