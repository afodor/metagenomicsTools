package scripts.ChinaDec2017.reducedMeta2017;
...
{	
	private static HashMap<String,String> getLineMap() throws Exception
	{
		...
		BufferedReader reader = new BufferedReader(new FileReader(new File(
				...
				"mergedMetadataApril2018" + File.separator +  "Metadata Subset" + 
						File.separator + "metadata_subset_04202018.txt")));
	...
	public static void main(String[] args) throws Exception
	{
		...
		for( int x=1; x < NewRDPParserFileLine.TAXA_ARRAY.length; x++ )
		{
			...
			BufferedWriter writer = new BufferedWriter(new FileWriter(new File(
					ConfigReader.getChinaDecember2017Dir() + File.separator + 
					"mergedMetadataApril2018" + File.separator +  
					"pcoa_" + NewRDPParserFileLine.TAXA_ARRAY[x] + "WithReducedMeta.txt")));
