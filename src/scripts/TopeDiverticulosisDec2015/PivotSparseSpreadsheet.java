...
public class PivotSparseSpreadsheet
{
	public static void main(String[] args) throws Exception
	{
		for( int x=1; x < NewRDPParserFileLine.TAXA_ARRAY.length; x++)
		{
			...
			getMap(ConfigReader.getTopeDiverticulosisDec2015Dir() 
			...
			File pivotedFile = 
					new File(
							ConfigReader.getTopeDiverticulosisDec2015Dir() 
							+ File.separator + "spreadsheets" +
			...
			wrapper.writeNormalizedLoggedDataToFile(ConfigReader.getTopeDiverticulosisDec2015Dir() 
					+ File.separator + "spreadsheets" +
					File.separator + "pivoted_" + 
