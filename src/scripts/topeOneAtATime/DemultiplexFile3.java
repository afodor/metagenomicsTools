...
public class DemultiplexFile3
{
	...
	public static HashMap<String, String> getAllMap(int includeInt) throws Exception
	{
		HashMap<String, String> map = new HashMap<String,String>();
		
		BufferedReader reader = new BufferedReader(new FileReader(new File(
			ConfigReader.getTopeOneAtATimeDir() + File.separator + 
			"Copy of All Diversticulosis Illumina Primer SeqWithFile3_4_Column.txt"
			)));
		...
		for(String s = reader.readLine(); s != null; s= reader.readLine())
		{
			...
			if( Integer.parseInt(splits[12]) == includeInt )
	...
	{
		HashMap<String, String> primerMap = getAllMap(3);
