...
<html lang="en">
  ...
  <meta property="fb:app_id" content="1401488693436528">
    ...
    <meta content="https://avatars3.githubusercontent.com/u/7323932?v=4&amp;s=400" property="og:image" /><meta content="GitHub" property="og:site_name" /><meta content="object" property="og:type" /><meta content="christianbach/tablesorter" property="og:title" /><meta content="https://github.com/christianbach/tablesorter" property="og:url" /><meta content="tablesorter - Flexible client-side table sorting" property="og:description" />

  <link rel="assets" href="https://assets-cdn.github.com/">
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6MTcwNzM3NDk3OmUzNGQ3OTcxNTRlYmMxNjU4NzlkOGFiNTgwNGY1MzdiZmI0NDBkZDkwY2RlZmIwNDA3YTY2ZjdhODdlMTdhYmM=--82466f705fd4ee28ac1196d7e6617855da3bcb49">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="125D:7F25:3D58B6E:6376F92:59D6883C" data-pjax-transient>
...
<meta content="collector.githubapp.com" name="octolytics-host" /><meta content="github" name="octolytics-app-id" /><meta content="https://collector.githubapp.com/github-external/browser_event" name="octolytics-event-url" /><meta content="125D:7F25:3D58B6E:6376F92:59D6883C" name="octolytics-dimension-request_id" /><meta content="iad" name="octolytics-dimension-region_edge" /><meta content="iad" name="octolytics-dimension-region_render" /><meta content="4459234" name="octolytics-actor-id" /><meta content="afodor" name="octolytics-actor-login" /><meta content="d339bcd86bab8c021f6196a107ce1de05d52ae58b5b286d402e100d48340f5e9" name="octolytics-actor-hash" />
<meta content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" name="analytics-location" />
  ...
  <meta name="user-login" content="afodor">

      <meta name="expected-hostname" content="github.com">
    <meta name="js-proxy-site-detection-payload" content="">

    <meta name="enabled-features" content="UNIVERSE_BANNER">

  <meta name="html-safe-nonce" content="d7351007a88bf713ad7818533a50c2726942ea1a">

  <meta http-equiv="x-pjax-version" content="56e4810595a933118253504c968993f3">
  ...
  <meta content="7323932" name="octolytics-dimension-user_id" /><meta content="christianbach" name="octolytics-dimension-user_login" /><meta content="19969620" name="octolytics-dimension-repository_id" /><meta content="christianbach/tablesorter" name="octolytics-dimension-repository_nwo" /><meta content="true" name="octolytics-dimension-repository_public" /><meta content="false" name="octolytics-dimension-repository_is_fork" /><meta content="19969620" name="octolytics-dimension-repository_network_root_id" /><meta content="christianbach/tablesorter" name="octolytics-dimension-repository_network_root_nwo" /><meta content="false" name="octolytics-dimension-repository_explore_github_marketplace_ci_cta_shown" />
...
<header class="Header  f5" role="banner">
  ...
  <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/christianbach/tablesorter/search" class="js-site-search-form" data-scoped-search-url="/christianbach/tablesorter/search" data-unscoped-search-url="/search" method="get"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div>
    <label class="form-control header-search-wrapper js-chromeless-input-container">
        <a href="/christianbach/tablesorter/blob/master/jquery.tablesorter.js" class="header-search-scope no-underline">This repository</a>
      <input type="text"
...
<ul class="user-nav d-flex flex-items-center list-style-none" id="user-links">
  <li class="dropdown js-menu-container js-header-notifications">
    <span class="d-inline-block  px-2">
      ...
      <a href="/notifications" aria-label="You have unread notifications" class="notification-indicator tooltipped tooltipped-s  js-socket-channel js-notification-indicator" data-channel="notification-changed:4459234" data-ga-click="Header, go to notifications, icon:unread" data-hotkey="g n">
...
<a class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <li class="dropdown js-menu-container">
    ...
    <details class="dropdown-details js-dropdown-details d-flex pl-2 flex-items-center">
      <summary class="HeaderNavlink name mt-1"
        ...
        <img alt="@afodor" class="avatar float-left mr-1" src="https://avatars2.githubusercontent.com/u/4459234?v=4&amp;s=40" height="20" width="20">
        <span class="dropdown-caret"></span>
      </summary>

      <ul class="dropdown-menu dropdown-menu-sw">
        <li class="dropdown-header header-nav-current-user css-truncate">
          Signed in as <strong class="css-truncate-target">afodor</strong>
        </li>

        <li class="dropdown-divider"></li>

        <li><a class="dropdown-item" href="/afodor" data-ga-click="Header, go to profile, text:your profile">
          Your profile
        </a></li>
        <li><a class="dropdown-item" href="/afodor?tab=stars" data-ga-click="Header, go to starred repos, text:your stars">
          Your stars
        </a></li>
        ...
        <li><!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="riWOajXQ5X8qGuxjQnKzAEXVheD0fm47xw1oRAPKxWeFuq/l8pb6MmUToDNxxOUM9bV3hUZH90sHI2VtgVxwLA==" /></div>
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="sr-only right-0" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="AS64BA6Cg7vTI1qJ1/UXsCfI10AluI2grI6V02EM7HcqsZmLycSc9pwqFtnkQ0G8l6glJZeBFNBsoJj645pZPA==" /></div>
          <button type="submit" class="dropdown-item dropdown-signout" data-ga-click="Header, sign out, icon:logout">
            Sign out
          </button>
</form>      </div>
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="8xQTs7gC4A4NoW7H998arxBSg7W1Wt/9UOVWTrY/H75zHa0h643por7yb6RjtTH2MVklJ9EoImhQv7vZUPfeUw==" /></div>      <input class="form-control" id="repository_id" name="repository_id" type="hidden" value="19969620" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/christianbach/tablesorter/unstar" class="starred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="RGGqLpNSZpen4IzcwvAwqaWfC1crcTyaMAO2OPo8u+A/TwOHNaMjv0JuC5ZUZF10nGsW9Qkv1GTL/pO+vi9hSg==" /></div>
      <button
        type="submit"
        ...
        <a class="social-count js-social-count" href="/christianbach/tablesorter/stargazers"
           aria-label="938 users starred this repository">
          938
        </a>
</form>
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/christianbach/tablesorter/star" class="unstarred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="XzLb/s81aCLbH61E3snUWMFNad+MMDJkQ7Q3sK+KbnY2vIuyNbHcmqbLpz6+UP7AA+s/ftySRgcy/nqlHJF87g==" /></div>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
  ...
  <li>
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/christianbach/tablesorter/fork" class="btn-with-count" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="qmFDHTMizX4uTwnt2xGcUorDxO3mLOCFf5KBvvZo51/0PphswYDAfvvAYaszWAMRr5afGjoV+f5iMkJ6Mvx8Qw==" /></div>
            <button
                type="submit"
    ...
    <a href="/christianbach/tablesorter/network" class="social-count"
       aria-label="500 users forked this repository">
      500
    </a>
  </li>
</ul>
...
<nav class="reponav js-repo-nav js-sidenav-container-pjax container"
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    <a href="/christianbach/tablesorter" class="js-selected-navigation-item selected reponav-item" data-hotkey="g c" data-selected-links="repo_source repo_downloads repo_commits repo_releases repo_tags repo_branches /christianbach/tablesorter" itemprop="url">
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    ...
    <a href="/christianbach/tablesorter/projects" class="js-selected-navigation-item reponav-item" data-hotkey="g b" data-selected-links="repo_projects new_repo_project repo_project /christianbach/tablesorter/projects">
    ...
    <div class="reponav-dropdown js-menu-container">
      ...
      <div class="dropdown-menu-content js-menu-content">
        <div class="dropdown-menu dropdown-menu-sw">
            <a class="dropdown-item" href="/christianbach/tablesorter/community" data-skip-pjax>
          ...
          <a class="dropdown-item" href="/christianbach/tablesorter/pulse" data-skip-pjax>
            <svg aria-hidden="true" class="octicon octicon-pulse" height="16" version="1.1" viewBox="0 0 14 16" width="14"><path fill-rule="evenodd" d="M11.5 8L8.8 5.4 6.6 8.5 5.5 1.6 2.38 8H0v2h3.6l.9-1.8.9 5.4L9 8.5l1.6 1.5H14V8z"/></svg>
            Pulse
          </a>
          <a class="dropdown-item" href="/christianbach/tablesorter/graphs" data-skip-pjax>
...
<div class="container new-discussion-timeline experiment-repo-nav">
  ...
  <!-- blob contrib key: blob_contributors:v21:a2bb2efc322a57680ca1a83c2c06003d -->
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
  ...
  <div class="commit-tease">
      ...
      <div>
        <img alt="@iustin" class="avatar" height="20" src="https://avatars0.githubusercontent.com/u/550045?v=4&amp;s=40" width="20" />
      ...
      <button type="button" class="btn-link muted-link contributors-toggle" data-facebox="#blob_contributors_box">
        <strong>6</strong>
         contributors
          ...
          <a class="avatar-link tooltipped tooltipped-s" aria-label="christianbach" href="/christianbach/tablesorter/commits/master/jquery.tablesorter.js?author=christianbach"><img alt="@christianbach" class="avatar" height="20" src="https://avatars1.githubusercontent.com/u/7323932?v=4&amp;s=40" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="leosilvadev" href="/christianbach/tablesorter/commits/master/jquery.tablesorter.js?author=leosilvadev"><img alt="@leosilvadev" class="avatar" height="20" src="https://avatars1.githubusercontent.com/u/5465808?v=4&amp;s=40" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="iustin" href="/christianbach/tablesorter/commits/master/jquery.tablesorter.js?author=iustin"><img alt="@iustin" class="avatar" height="20" src="https://avatars0.githubusercontent.com/u/550045?v=4&amp;s=40" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="bamyers99" href="/christianbach/tablesorter/commits/master/jquery.tablesorter.js?author=bamyers99"><img alt="@bamyers99" class="avatar" height="20" src="https://avatars3.githubusercontent.com/u/4949828?v=4&amp;s=40" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="aran112000" href="/christianbach/tablesorter/commits/master/jquery.tablesorter.js?author=aran112000"><img alt="@aran112000" class="avatar" height="20" src="https://avatars0.githubusercontent.com/u/3313791?v=4&amp;s=40" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="iajrz" href="/christianbach/tablesorter/commits/master/jquery.tablesorter.js?author=iajrz"><img alt="@iajrz" class="avatar" height="20" src="https://avatars0.githubusercontent.com/u/4443604?v=4&amp;s=40" width="20" /> </a>
    ...
    <div id="blob_contributors_box" style="display:none">
      ...
      <ul class="facebox-user-list" data-facebox-id="facebox-description">
          <li class="facebox-user-list-item">
            <img alt="@christianbach" height="24" src="https://avatars3.githubusercontent.com/u/7323932?v=4&amp;s=48" width="24" />
            <a href="/christianbach">christianbach</a>
          </li>
          <li class="facebox-user-list-item">
            <img alt="@leosilvadev" height="24" src="https://avatars3.githubusercontent.com/u/5465808?v=4&amp;s=48" width="24" />
            <a href="/leosilvadev">leosilvadev</a>
          </li>
          <li class="facebox-user-list-item">
            <img alt="@iustin" height="24" src="https://avatars2.githubusercontent.com/u/550045?v=4&amp;s=48" width="24" />
            <a href="/iustin">iustin</a>
          </li>
          <li class="facebox-user-list-item">
            <img alt="@bamyers99" height="24" src="https://avatars1.githubusercontent.com/u/4949828?v=4&amp;s=48" width="24" />
            <a href="/bamyers99">bamyers99</a>
          </li>
          <li class="facebox-user-list-item">
            <img alt="@aran112000" height="24" src="https://avatars2.githubusercontent.com/u/3313791?v=4&amp;s=48" width="24" />
            <a href="/aran112000">aran112000</a>
          </li>
          <li class="facebox-user-list-item">
            <img alt="@iajrz" height="24" src="https://avatars2.githubusercontent.com/u/4443604?v=4&amp;s=48" width="24" />
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      <a href="/christianbach/tablesorter/raw/master/jquery.tablesorter.js" class="btn btn-sm BtnGroup-item" id="raw-url">Raw</a>
        <a href="/christianbach/tablesorter/blame/master/jquery.tablesorter.js" class="btn btn-sm js-update-url-with-hash BtnGroup-item" data-hotkey="b">Blame</a>
      <a href="/christianbach/tablesorter/commits/master/jquery.tablesorter.js" class="btn btn-sm BtnGroup-item" rel="nofollow">History</a>
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/christianbach/tablesorter/edit/master/jquery.tablesorter.js" class="inline-form js-update-url-with-hash" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="2bK17oTsOn+8U+KpXl17TQWOQhg0H+jXuHvW/f9Dy5tmAK+c8qNx5zPpyL1Z/ZX28BG/NzUYxVSgnQ2fw6t8aA==" /></div>
          <button class="btn-octicon tooltipped tooltipped-nw" type="submit"
            aria-label="Fork this project and edit the file" data-hotkey="e" data-disable-with>
            <svg aria-hidden="true" class="octicon octicon-pencil" height="16" version="1.1" viewBox="0 0 14 16" width="14"><path fill-rule="evenodd" d="M0 12v3h3l8-8-3-3-8 8zm3 2H1v-2h1v1h1v1zm10.3-9.3L12 6 9 3l1.3-1.3a.996.996 0 0 1 1.41 0l1.59 1.59c.39.39.39 1.02 0 1.41z"/></svg>
          </button>
</form>        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/christianbach/tablesorter/delete/master/jquery.tablesorter.js" class="inline-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="FhgQrsIwWXURepau6ueetbTVMKqGd8uK7+/RvgT5g1XUW2F0QTeOv8lcNioRr/lBVT9os87PuViiszexmyuUIQ==" /></div>
  ...
  <div class="BlobToolbar position-absolute js-file-line-actions dropdown js-menu-container js-select-menu d-none" aria-hidden="true">
    ...
    <div class="dropdown-menu-content js-menu-content" id="inline-file-actions">
      <ul class="BlobToolbar-dropdown dropdown-menu dropdown-menu-se mt-2">
        ...
        <li><a href="/christianbach/tablesorter/blame/774576308e8a25aa9d68b7fe3069b79543992d7a/jquery.tablesorter.js" class="dropdown-item js-update-url-with-hash" id="js-view-git-blame">View git blame</a></li>
          <li><a href="/christianbach/tablesorter/issues/new" class="dropdown-item" id="js-new-issue">Open new issue</a></li>
      </ul>
    </div>
  </div>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between py-6 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2017 <span title="0.24209s from unicorn-877545986-q93t9">GitHub</span>, Inc.</li>
