...
public class PivotDada2ToOTU
{
	public static void main(String[] args) throws Exception
	{
		 ...
		 writePivotTable(new File("C:\\tb_RDP\\01_PearMergeReads\\output\\pivotOutCut9.txt"), 
				 new File("C:\\tb_RDP\\01_PearMergeReads\\output\\dada2_fastaSeqs.txt"),
				 map);
	}
