...
public class ConvertBiom
{
	public static void main(String[] args) throws Exception
	{
		BufferedReader reader = new BufferedReader(new FileReader(new File(ConfigReader.getIanAnorexiaDir() + 
				File.separator + "an_otu_table.biom")));
		...
		BufferedWriter writer = new BufferedWriter(new FileWriter(new File(
				ConfigReader.getIanAnorexiaDir() + 
				File.separator + "anSamplesTaxaAsColumns.txt")));
